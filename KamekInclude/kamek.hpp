...
class PageLoadHook2 : public DoFuncsHook {
   ...
   public:
    template <typename F>
    PageLoadHook2(F f) : DoFuncsHook(f, &pageLoadHooks2) {}
    static void Exec(void* a1 = nullptr, void* a2 = nullptr, void* a3 = nullptr) { DoFuncsHook::Exec(pageLoadHooks2, a1, a2, a3); }
};
